...
module debug_tracer #(
    ...
    // and walking it forward needs ctl_window -- which on 2026-08-23 turned out
    // not to reach the core, leaving the instrument stuck on the first 128
    // events with no way to see anything later. Ring mode needs no control
