...
module maincpu (
	...
	// address compare. An exact compare only fires for a move.b addressed
	// at 0xC00013 itself; a move.w to 0xC00012 or a move.l to 0xC00010
	...
	// would never match, and the 68020's sound commands would silently
	// never reach the Z80.
